...
class ChatsFragmentAdapter (private val messageItemList: List<MessageItem>,
                            private val listener: OnItemClickListener) : RecyclerView.Adapter<ChatsFragmentAdapter.MessageViewHolder>() {
